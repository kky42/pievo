...
process.env.PIEVO_RATE_LIMIT = "on";
process.env.PIEVO_RL_IP_BURST = "3";
process.env.PIEVO_RL_IP_PER_SEC = "1";
...
afterAll(() => {
  delete process.env.PIEVO_RATE_LIMIT;
  delete process.env.PIEVO_RL_IP_BURST;
  delete process.env.PIEVO_RL_IP_PER_SEC;
});
