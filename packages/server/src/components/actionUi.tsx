 ...
 *  (Codex executes on its own CLI; telemetry is still degraded, with no session
 *  id). Swap per-agent once another agent yields a resumable session. */
 ...
 * Codex executes, but daemon telemetry is still degraded for it).
 */
