...
function makeDetail(over: { state?: DetailState; online?: boolean; protocol?: number | null; running?: boolean; cancelRequested?: boolean } = {}): JobDetail {
  ...
  return {
    ...
    machine: { id: 'm1', name: 'MacBook Pro', online: over.online ?? true, presence: (over.online ?? true) ? 'online' : 'offline', lastSeen: null, daemonProtocol: over.protocol === undefined ? 3 : over.protocol, daemonVersion: '2.2.0', needsUpdate: false, requiredDaemonVersion: '2.2.0' },
  }
}
