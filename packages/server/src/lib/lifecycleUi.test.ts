...
function detail(summary: JobSummary, machine: Partial<JobDetail['machine']> = {}): JobDetail {
  return {
    ...
    machine: { id: 'm1', name: 'MacBook Pro', online: true, presence: 'online', lastSeen: null, daemonProtocol: 3, daemonVersion: '2.2.0', needsUpdate: false, requiredDaemonVersion: '2.2.0', ...machine },
  }
}
