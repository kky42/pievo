 ...
 * optional `PIEVO_DB_POOL_MODE` override via `env.ts`), tests import this
 ...
 * detected here — set `PIEVO_DB_POOL_MODE=transaction` (see `env.ts`
 ...
 * (the `PIEVO_DB_POOL_MODE` escape hatch).
 */
