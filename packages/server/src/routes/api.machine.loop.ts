...
/** Bearer device token from the request (the machine's persisted ~/.pievo token). */
 ...
 *   GET    list the loops bound to this machine (`pievo loops`)
 *   PATCH  edit a loop's scheduling envelope (`pievo edit`)
 */
