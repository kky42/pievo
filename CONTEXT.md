...
- Schedules are durable per conversation.
  ...
  - `background` schedules start a fresh plain Pi run with the same profile settings, without Pievo chat/schedule tools, and send the final result back to the chat.
